...
export const Ticket = ({ticketObject, currentUser, employees, getAllTickets}) => {
        ...
        if(ticketObject.employeeTickets.length>0) {
            const ticketEmployeeRelationships = ticketObject.employeeTickets[0]
            assignedEmployee = employees.find(employee => employee.id === ticketEmployeeRelationships.employeeId)
        }
